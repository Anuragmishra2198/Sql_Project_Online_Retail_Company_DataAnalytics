...
('Washing Machine', 4, 499.99, 20),
('Microwave Oven', 4, 199.99, 15),
('Basketball', 5, 29.99, 40),
('Tennis Racket', 5, 79.99, 25);
...
('Emily', 'Clark', 'emily.clark@example.com', '456-789-0123', '123 Maple St.', 'Austin', 
'TX', '73301', 'USA'),
('Robert', 'Williams', 'robert.williams@example.com', '567-890-1234', '456 Pine St.', 'Chicago', 
'IL', '60601', 'USA');
